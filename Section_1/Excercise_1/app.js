...
let codeString = `var globalVariable = "Soy una variable global";
...
while (questionNumber <= 3) {
  switch (questionNumber) {
    case 1:
      userAnswer = prompt(
        "Primera pregunta: ¿Cuál es el valor de globalVariable fuera de la función? \n1. Soy una variable local. \n2. Soy una variable de bloque. \n3. Soy una variable global."
      );
      if (userAnswer === "3") {
        alert(
          "¡Correcto! Fuera de la función, el valor de globalVariable es: " +
            globalVariable +
            ". Esto es porque globalVariable es una variable global y su valor puede ser accedido desde cualquier parte del código."
        );
        questionNumber++;
    ...
    case 2:
      userAnswer = prompt(
        "Segunda pregunta: ¿Cuál es el valor de blockVariable dentro del bloque? \n1. Soy una variable local. \n2. Soy una variable de bloque. \n3. Soy una variable global."
      );
      if (userAnswer === "2") {
        alert(
          "¡Correcto! Dentro del bloque, el valor de blockVariable es: 'Soy una variable de bloque'. Esto es porque blockVariable es una variable de bloque y su valor solo puede ser accedido dentro del bloque donde fue declarada."
        );
        questionNumber++;
    ...
    case 3:
      userAnswer = prompt(
        "Tercera pregunta: ¿Cuál es el valor de functionVariable dentro de la función? \n1. Soy una variable local. \n2. Soy una variable de bloque. \n3. Soy una variable global."
      );
      if (userAnswer === "1") {
        alert(
          "¡Correcto! Dentro de la función, el valor de functionVariable es: Variable dentro de un funcion. Esto es porque functionVariable es una variable local y su valor solo puede ser accedido dentro de la función donde fue declarada."
        );
        questionNumber++;
